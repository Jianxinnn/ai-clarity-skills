...
for skill in orient-me plain-me grill-me trim-me; do ln -s "$PWD/skills/$skill" ~/.codex/skills/$skill; done
```
...
```text
orient-me -> plain-me -> grill-me -> trim-me
reset context -> lower comprehension load -> clarify intent -> simplify execution
```
