...
- `pinpoint-me`: cut through noisy context and give the direct answer the user actually needs.
...
for skill in orient-me plain-me pinpoint-me grill-me untangle-me trim-me; do ln -s "$PWD/skills/$skill" ~/.codex/skills/$skill; done
```
...
```text
orient-me -> plain-me -> pinpoint-me -> grill-me -> untangle-me -> trim-me
reset context -> lower comprehension load -> direct answer -> clarify intent -> map the codebase -> simplify execution
```
